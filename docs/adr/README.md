...
| [0016](0016-harness-growing-mission.md) | ミッションを「プロジェクトスコープのハーネス育成」に特化する | 承認済み（ADR-0018, ADR-0019 により一部改訂） |
| [0017](0017-hooks-creator-skill.md) | hooks 作成支援を 3 本目の共有スキルとして追加する | 廃止（ADR-0018 により置換） |
| [0018](0018-subagent-creator-skill.md) | サブエージェント定義作成支援を 4 本目の共有スキルとして追加する | 承認済み |
| [0019](0019-opencode-support.md) | OpenCode を 4 番目の対応ツールとして追加する | 承認済み |
