...
imk-skill-creator スキル、そしてユーザー自身の常駐指示を 3 ツールへ一元配布する仕組み。
...
1. プロジェクトスコープの現状確認 — CLAUDE.md / AGENTS.md、verify / tdd /
   domain-modeling / grilling スキル、CONTEXT.md（用語集）、ADR 置き場、
